# Hitster Cloudflare 1.4.18-diagnose8 – Hybridtransport
...
Das Paket enthält `termux-deploy.sh`, führt alle paketinternen Tests aus, aktualisiert `Resa59/hitr` und prüft anschließend den Health-Build `1.4.18-diagnose8`.
